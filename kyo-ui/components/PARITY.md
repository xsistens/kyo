...
| DataTable | cell and row editing, row and column grouping, lazy mode, column resize, reorder and toggle, frozen columns, virtual scrolling, the select-all header, context menu, export, state persistence | Client-side behaviours, or later phases. |
